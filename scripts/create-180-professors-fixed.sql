-- Création de 180 professeurs avec la fonction create_user_profile
-- Utilisation de la syntaxe correcte avec paramètres nommés
...
-- Insérer les professeurs avec la fonction create_user_profile
SELECT 
  create_user_profile(
    p_email := email,
